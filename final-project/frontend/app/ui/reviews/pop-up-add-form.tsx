        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <span className="flex select-none items-center pl-3 text-gray-500 sm:text-sm">Hotel/</span>
                  <input
                    type="text"
                    name="hotelname"
                    id="hotelname"
            ...
            <div className="sm:col-span-4">
              ...
              <div className="sm:col-span-3 bottom-10">
              
              <label htmlFor="country" className="block text-sm font-medium leading-6 text-gray-900  top-3">
                Country
              </label>
              <div className="mt-2  bottom-30">
                <select
                  id="country"
                  name="country"
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="relative flex gap-x-3">
                  ...
                  <div className="text-sm leading-6">
                    ...
                    <p className="text-gray-500">Get notified when a new update about the hotel.</p>
                  </div>
                </div>
                <div className="relative flex gap-x-3">
                  <div className="flex h-6 items-center">
                  ...
                  <div className="text-sm leading-6">
                    ...
                    <p className="text-gray-500">Get notified when a candidate accepts or rejects a recommendation.</p>
                  </div>
                </div>
              </div>
            </fieldset>
